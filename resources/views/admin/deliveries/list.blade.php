...
<div class="block-header">
    <div class="row clearfix">
        <div class="col-xl-5 col-md-5 col-sm-12">
            ...
            <span>Danh sách Phương Thức Giao Hàng,</span>
        </div>            
        <div class="col-xl-7 col-md-7 col-sm-12 text-md-right">
            <div class="d-flex align-items-center justify-content-md-end mt-4 mt-md-0 flex-wrap vivify pullUp delay-550">
                <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                    ...
                    <h5 class="mb-0">((totalLevels)) Phương Thức Giao Hàng</h5>
                </div>
                ...
                <div class="tab-content mt-0">
                    ...
                    <div class="form-group c_form_group bg-white">
                        <div class="input-group">
                            <input type="text" ng-model="nameCondition" ng-keydown="changeKey($event)" class="form-control" placeholder="Tên Phương Thức Giao Hàng">
                        ...
                        <table class="table table-hover table-custom spacing5 mb-0">
                            ...
                            <tbody>
                                <tr ng-repeat="content in data">
                                    <td>
                                        <span ng-if="content.edit == 1">((content.delivery))</span>
                                        <input ng-if="content.edit == 2" autofocus type="text" ng-model="content.delivery" class="form-control edit-in-table" placeholder="Tên Phương Thức Giao Hàng">
                                    </td>
                                    <td>
                                        <span ng-if="content.edit == 1">((content.time))</span>
                                        <input ng-if="content.edit == 2" autofocus type="text" ng-model="content.time" class="form-control edit-in-table" placeholder="Thời Gian Giao Hàng">
                                    </td>
                                    <td>
                                        <span ng-if="content.edit == 1">(( parseCurency(content.price) ))</span>
                                        <input ng-if="content.edit == 2" autofocus type="text" ng-model="content.price" class="form-control edit-in-table" placeholder="Giá">
                                    </td>
                                    <td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group c_form_group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" ng-model="name_deliveries" class="form-control" placeholder="Tên Phương Thức Giao Hàng">
                                            </div>
                                        </div>
                                        <div class="form-group c_form_group">
                                            <label>Thời Gian Giao Hàng</label>
                                            <div class="input-group">
                                                <input type="text" ng-model="time_deliveries" class="form-control" placeholder="Thời Gian Giao Hàng">
                                            </div>
                                        </div>
                                        <div class="form-group c_form_group">
                                            <label>Giá</label>
                                            <div class="input-group">
                                                <input type="text" ng-model="price_deliveries" class="form-control" placeholder="Giá">
                                            </div>
                                        </div>
                                    </div>
...
customInterpolationApp.controller('AppController', function($scope, $http , $q) {
         ...
         $scope.run_action = function(){
            ...
            $scope.pageLoad = 1;
            $http.get("{{route('admin.getListDeliveries')}}?page="+$scope.pageLoad+"&delivery="+$scope.nameCondition).then(function(data, status) {
        ...
        $scope.updateConfirm = function(i){
            Swal.fire({
                title: "Xác Nhận",
                text: "Bạn có đồng ý thay đổi phương thức này không?",
                type: "warning",
                showCancelButton: !0,
                ...
                $http.post('/admin/deliveries/edit/'+i.id, body).then(function(data, status) {
                    i.edit = 1;
        ...
        $scope.addConfirm = function(){
            ...
            Swal.fire({
                title: "Xác Nhận",
                text: "Bạn có đồng ý thêm phương thức này không?",
                type: "warning",
                showCancelButton: !0,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                ...
                var body = { 
                    _token: CSRF_TOKEN ,
                    delivery : $scope.name_deliveries,
                    time : $scope.time_deliveries,
                    price : $scope.price_deliveries
                };
                $http.post("{{route('admin.addDeliveries')}}", body).then(function(data, status) {
                    $scope.run_action();
                    $('.new-project-modal').modal("hide");
                    $scope.price_deliveries = '';
                    $scope.name_deliveries = '';
        ...
        $scope.delete = function(id_delete){
            Swal.fire({
                title: "Xác Nhận",
                text: "Bạn có đồng ý xóa phương thức này không?",
                type: "warning",
                showCancelButton: !0,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                ...
                $.ajax({
                    url: "/admin/deliveries/delete/"+id_delete,
                    type: 'GET',
                    dataType: 'json',
