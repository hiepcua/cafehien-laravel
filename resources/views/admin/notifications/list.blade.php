...
@section('title', 'Cấu Hình Tin Nhắn')
...
<div class="block-header">
    <div class="row clearfix">
        <div class="col-xl-5 col-md-5 col-sm-12">
            ...
            <span>Danh sách Mẫu Tin Nhắn,</span>
        </div>            
        <div class="col-xl-7 col-md-7 col-sm-12 text-md-right">
            <div class="d-flex align-items-center justify-content-md-end mt-4 mt-md-0 flex-wrap vivify pullUp delay-550">
                <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                    ...
                    <h5 class="mb-0">((totalLevels)) Mẫu Tin Nhắn</h5>
                </div>
                ...
                <div class="tab-content mt-0">
                    ...
                    <div class="form-group c_form_group bg-white">
                        <div class="input-group">
                            <input type="text" ng-model="nameCondition" ng-keydown="changeKey($event)" class="form-control" placeholder="Tên Mẫu Tin Nhắn">
                        ...
                        <table class="table table-hover table-custom spacing5 mb-0">
                            ...
                            <tbody>
                                <tr ng-repeat="content in data">
                                    ...
                                    <td>
                                        <span ng-if="content.edit == 1">((content.title))</span>
                                        <input ng-if="content.edit == 2" autofocus type="text" ng-model="content.title" class="form-control edit-in-table" placeholder="Tên Mẫu Tin">
                                    </td>
                                    <td>
                                        <span ng-if="content.edit == 1">((content.message))</span>
                                        <input ng-if="content.edit == 2" autofocus type="text" ng-model="content.message" class="form-control edit-in-table" placeholder="Nội Dung">
                                    </td>
                                    <td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group c_form_group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" ng-model="name_deliveries" class="form-control" placeholder="Tên Mẫu Tin">
                                            </div>
                                        </div>
                                        <div class="form-group c_form_group">
                                            <label>Nội Dung</label>
                                            <div class="input-group">
                                                <input type="text" ng-model="time_deliveries" class="form-control" placeholder="Nội Dung">
                                            </div>
                                        </div>
                                    </div>
...
customInterpolationApp.controller('AppController', function($scope, $http , $q) {
         ...
         $scope.run_action = function(){
            ...
            $scope.pageLoad = 1;
            $http.get("{{route('admin.getListNotifications')}}?page="+$scope.pageLoad+"&title="+$scope.nameCondition).then(function(data, status) {
        ...
        $scope.updateConfirm = function(i){
            Swal.fire({
                title: "Xác Nhận",
                text: "Bạn có đồng ý thay đổi mẫu tin này không?",
                type: "warning",
                showCancelButton: !0,
                ...
                $http.post('/admin/notifications/edit/'+i.id, body).then(function(data, status) {
                    i.edit = 1;
        ...
        $scope.addConfirm = function(){
            ...
            Swal.fire({
                title: "Xác Nhận",
                text: "Bạn có đồng ý thêm mẫu tin này không?",
                type: "warning",
                showCancelButton: !0,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                ...
                var body = { 
                    _token: CSRF_TOKEN ,
                    title : $scope.name_deliveries,
                    message : $scope.time_deliveries,
                };
                $http.post("{{route('admin.addNotifications')}}", body).then(function(data, status) {
                    $scope.run_action();
                    $('.new-project-modal').modal("hide");
                    $scope.price_deliveries = '';
                    $scope.name_deliveries = '';
