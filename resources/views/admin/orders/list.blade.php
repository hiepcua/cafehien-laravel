                        ...
                        <table class="table table-hover table-custom spacing5 mb-0">
                            ...
                            <tbody>
                                <tr ng-repeat="content in data">
                                    ...
                                    <td>
                                        ((content.buy.name))
                                        <p class="mb-0">((content.buy.phone))</p>
                                    </td>
                                    <td>
                                        <span >((content.address)) - ((content.ward.ward)) - ((content.district.district)) - ((content.province.province))</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span >((content.order_statuses.status))</span>
                                    </td>
                                    <td>
                                        <a href="/admin/orders/detail/((content.id))" class="btn btn-primary theme-bg btn-sm a-button-table ">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </td>
                                </tr>
...
customInterpolationApp.controller('AppController', function($scope, $http , $q) {
         ...
         $scope.run_action = function(){
            ...
            $http.post('/admin/orders/get-list', body).then(function(data, status) {
