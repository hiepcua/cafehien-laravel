...
@section('parentPageTitle', 'Quốc Gia')
        ...
        <div class="col-xl-7 col-md-7 col-sm-12 text-md-right">
            <div class="d-flex align-items-center justify-content-md-end mt-4 mt-md-0 flex-wrap vivify pullUp delay-550">
                <div class="border-right pr-4 mr-4 mb-2 mb-xl-0">
                    ...
                    <h5 class="mb-0">((totalLevels)) Quốc Gia</h5>
                </div>
                ...
                <div class="tab-content mt-0">
                    ...
                    <div class="form-group c_form_group bg-white">
                        <div class="input-group">
                            <input type="text" ng-model="nameCondition" ng-keydown="changeKey($event)" class="form-control" placeholder="Tên Quốc Gia">
                        ...
                        <table class="table table-hover table-custom spacing5 mb-0">
                            ...
                            <tbody>
                                <tr ng-repeat="content in data">
                                    ...
                                    <td>
                                        <span ng-if="content.edit == 1">((content.origin))</span>
                                        <input ng-if="content.edit == 2" autofocus type="text" ng-model="content.origin" class="form-control edit-in-table" placeholder="Tên Quốc Gia">
                                    </td>
                                    <td>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Thêm Quốc Gia Mới</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group c_form_group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" ng-model="name_settings" class="form-control" placeholder="Tên Quốc Gia">
                                            </div>
                                        </div>
                                    </div>
...
customInterpolationApp.controller('AppController', function($scope, $http , $q) {
         ...
         $scope.run_action = function(){
            ...
            $scope.pageLoad = 1;
            $http.get("{{route('admin.getListOrigins')}}?page="+$scope.pageLoad+"&name="+$scope.nameCondition).then(function(data, status) {
        ...
        $scope.updateConfirm = function(i){
            Swal.fire({
                title: "Xác Nhận",
                text: "Bạn có đồng ý thay đổi giá trị cài đặt này không?",
                type: "warning",
                showCancelButton: !0,
                ...
                $http.post('/admin/origins/edit/'+i.id, body).then(function(data, status) {
                    i.edit = 1;
        ...
        $scope.addConfirm = function(){
            ...
            Swal.fire({
                ...
                $http.post("{{route('admin.addOrigins')}}", body).then(function(data, status) {
                    $scope.run_action();
                    $('.new-project-modal').modal("hide");
                    $scope.name_settings = '';
                    $scope.key_settings = '';
        ...
        $scope.delete = function(id_delete){
            Swal.fire({
                ...
                $.ajax({
                    url: "/admin/origins/delete/"+id_delete,
                    type: 'GET',
                    dataType: 'json',
