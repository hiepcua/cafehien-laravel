                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group c_form_group ">
                                    ...
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Họ Và Tên" aria-label="Họ Và Tên" name="name" value="{{@old('name')}}" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="form-group c_form_group">
                                    <label>Số Điện Thoại</label>
                                    <div class="input-group">
                                        <input required type="text" class="form-control" placeholder="Số Điện Thoại" name="phone" aria-label="Số Điện Thoại" value="{{@old('phone')}}" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="form-group c_form_group">
                                    <label>Email</label>
                                    <div class="input-group">
                                        <input required type="text" class="form-control" placeholder="Email" name="email" aria-label="Email" value="{{@old('email')}}" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="form-group c_form_group">
                                    <label>Code</label>
                                    <div class="input-group">
                                        <input required type="text" class="form-control code-text" placeholder="code" name="code" aria-label="code" value="{{@old('code')}}" aria-describedby="basic-addon1">
                                        <button type="button" class="btn btn-primary theme-bg" ng-click="genCode()">Tạo Mã Code</button>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <ul id="images">
                                            <li>   
                                                <input class="input_image" type="hidden" id="chooseImage_input1" name="avatar" value="{{@old('avatar') != '' ? @old('avatar') : '' }}">
                                                <div id="chooseImage_div1" style="display: none;">
                                                    <img src="{{@old('avatar') != '' ? @old('avatar') : '' }}" id="chooseImage_img1" style="max-width: 150px; max-height:150px; border:dashed thin;"></img>
                                                </div>
                            ...
                            <div class="col-lg-12 col-md-12">
                                ...
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <input type="password" value="{{@old('password')}}" required class="form-control focus_pw" name="password" aria-label="Mật Khẩu" value="" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <input data-provide="datepicker" data-date-autoclose="true" name="birthday" class="form-control birthday" placeholder="Chọn Ngày" value="{{@old('birthday')}}">
                                    </div>
                                </div>
                                <div class="form-group c_form_group">
                                    <label>Địa Chỉ</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" placeholder="Address" name="address" aria-label="Email" value="{{@old('address')}}" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                <div class="form-group c_form_group">
                                    <label>Cấp Bậc</label>
                                    ...
                                    <div class="input-group">
                                        <select class="custom-select" name="province_id" ng-model="province" ng-change="getDistricts()">
                                            ...
                                            @foreach($listProvinces as $item)
                                                <option value="{{$item->id}}" @if($item->id == @old('province_id')) selected @endif>{{$item->province}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" placeholder="Điểm Tích Lũy" name="points" aria-label="Điểm Tích Lũy" value="{{@old('points')}}" aria-describedby="basic-addon1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <select class="custom-select" name="is_active">
                                            <option value="1" @if(@old('is_active') == 1) selected="selected"  @endif>Mở</option>
                                            <option value="0" @if(@old('is_active') == 0) selected="selected"  @endif>Khóa</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group c_form_group">
                                    ...
                                    <div class="input-group">
                                        <select class="custom-select" name="notify">
                                            <option value="1" @if(@old('notify') == 1) selected="selected"  @endif>Mở</option>
                                            <option value="0" @if(@old('notify') == 0) selected="selected"  @endif>Khóa</option>
                                        </select>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary theme-bg">Lưu Lại</button>
...
customInterpolationApp.controller('AppController', function($scope, $http , $q) {
        ...
        $scope.genCode = function(){
            var gen = 'DL'+ Math.ceil(Math.random()*10000000000000000);
