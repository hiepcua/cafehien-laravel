                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-12">
                        <div class="contact-form-wrap">
                            ...
                            <form id="contact-form-lienhe" action="" method="post">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
...
@section('script')
<script src="https://maps.google.com/maps/api/js?sensor=false&amp;libraries=geometry&amp;v=3.22&amp;key={{@Helper::getSocialLink(13)->value}}"></script>
<script>
