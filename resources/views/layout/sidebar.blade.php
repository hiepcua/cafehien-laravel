<div id="left-sidebar" class="sidebar">
    ...
    <div class="navbar-brand">
        <a href="{{route('dashboard.index')}}"><img src="{{ asset('fe/assets/images/cafenhien.png') }}" alt="Mooli Logo" class="img-fluid logo" width="300"></a>
            ...
            <ul id="main-menu" class="metismenu animation-li-delay">
                ...
                <li class="{{ @$menu_parent_active === 'setting-groups' ? 'active' : null }} parent-list">
                    ...
                    <ul>
                        ...
                        <li class="{{ @$menu_active === 'contacts' ? 'active' : null }}">
                            <a href="{{route('admin.listContacts')}}">
                                <i class="fa fa-envelope-o"></i> <span>Liên Hệ</span>
                            </a>
                        </li>
                        <li class="{{ @$menu_active === 'ads' ? 'active' : null }}">
                            <a href="{{route('admin.listAdvertisements')}}">
                                <i class="fa fa-address-card-o"></i> <span>Quảng Cáo</span>
                            </a>
                        </li>
                    </ul>
                </li>
                <li class="{{ @$menu_parent_active === 'partner' ? 'active' : null }} parent-list">
                    <a class="has-arrow"><i class="fa fa-user-circle"></i><span>Đối Tác</span></a>
                    <ul>
                        <li class="{{ @$menu_active === 'partnerstyle' ? 'active' : null }}">
                            <a href="{{route('admin.listPartnerStyle')}}">
                                <i class="fa fa-bars"></i> <span>Loại Đối Tác</span>
                            </a>
                        </li>
                        <li class="{{ @$menu_active === 'partner' ? 'active' : null }}">
                            <a href="{{route('admin.listPartner')}}">
                                <i class="fa fa-user-circle"></i> <span>Yêu Cầu Đối Tác</span>
                            </a>
                        </li>
                ...
                <li class="{{ @$menu_active === 'sales' ? 'active' : null }}">
                    <a href="{{route('admin.listSales')}}">
                        <i class="fa fa-shopping-basket"></i> <span>Đơn Hàng Khuyến Mãi</span>
                    </a>
                </li>
